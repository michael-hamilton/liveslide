...
var _michael_hamilton$liveslide$LiveSlide$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return model + 1;
	});
var _michael_hamilton$liveslide$LiveSlide$server = 'wss://localhost:3000/ws';
var _michael_hamilton$liveslide$LiveSlide$SendMessage = {ctor: 'SendMessage'};
var _michael_hamilton$liveslide$LiveSlide$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_michael_hamilton$liveslide$LiveSlide$SendMessage),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _michael_hamilton$liveslide$LiveSlide$main = _elm_lang$html$Html$beginnerProgram(
	{model: 0, view: _michael_hamilton$liveslide$LiveSlide$view, update: _michael_hamilton$liveslide$LiveSlide$update})();

var Elm = {};
Elm['LiveSlide'] = Elm['LiveSlide'] || {};
if (typeof _michael_hamilton$liveslide$LiveSlide$main !== 'undefined') {
    _michael_hamilton$liveslide$LiveSlide$main(Elm['LiveSlide'], 'LiveSlide', undefined);
}
